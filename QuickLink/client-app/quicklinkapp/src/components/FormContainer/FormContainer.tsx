        ...
        <div className='container mx-auto p-2'>
            <div className='bg-banner my-8 rounded-xl bg-cover bg-center'>
                <div className='w-full h-full rounded-xl p-20 backdrop-brightness-50'>
                    <h2 className='text-white font-bold text-4xl text-center pt-2 pb-4'>QuickLink App</h2>
                    <p className='text-white text-2xl text-center pb-2 font-extralight'>
                        Paste your longer and untidy link to shorten it!
                    </p>
                    <p className='text-white text-l text-center pb-2 font-thin'>
                        Its a free URL shortener app for you!
                    </p>
                    <form onSubmit={handleSubmit}>
                        <div className='flex'>
                            <div className="relative w-full">
                                ...
                                <input type='text' placeholder='add your link' required className='block w-full ps-32 p-4 text-sm text-gray-900 border border-gray-300 rounded-lg bg-white focus:ring-blue-500 focus:border-blue-500'
                                value={fullUrl}
